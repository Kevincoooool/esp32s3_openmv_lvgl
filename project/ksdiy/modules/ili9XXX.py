...
class ili9XXX:
    ...
    def __init__(self,
        miso=13, mosi=11, clk=12, cs=10, dc=9, rst=-1, power=-1, backlight=-1, backlight_on=0, power_on=0,
        spihost=esp.HSPI_HOST, mhz=60, factor=4, hybrid=True, width=320, height=240,
        ...
        self.buf_size = (self.width * 20 * lv.color_t.__SIZE__) // factor
...
#                    esp.spi_transaction_t.__SIZE__, esp.MALLOC_CAP.DMA))
    ...
    cycles_in_ms = machine.freq() // 1000
