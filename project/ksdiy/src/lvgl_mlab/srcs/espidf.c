...
uint32_t gpio_input_get(void){return 0;}

uint32_t gpio_input_get_high(void){return 0;}

// void gpio_intr_handler_register(gpio_intr_handler_fn_t fn, void *arg){}

// uint32_t gpio_intr_pending(void){return 0;}

// uint32_t gpio_intr_pending_high(void){return 0;}
