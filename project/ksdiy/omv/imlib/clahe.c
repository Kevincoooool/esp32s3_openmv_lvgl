 ...
 *   uiXRes - Image omv_resolution in the X direction
 *   uiYRes - Image omv_resolution in the Y direction
 ...
 */
{
    ...
    if (uiXRes % uiNrX) return -3;        /* x-omv_resolution no multiple of uiNrX */
    if (uiYRes % uiNrY) return -4;        /* y-omv_resolution no multiple of uiNrY */
 ...
 * uiXRes      - omv_resolution of image in x-direction
