...
ifeq ($(SD), s110)
	INC += -I$(SD_DIR)/$(SD)_$(MCU_VARIANT)_$(SOFTDEV_VERSION)/$(SD)_$(MCU_VARIANT)_$(SOFTDEV_VERSION)_API/include
	CFLAGS += -DBLUETOOTH_SD_DEBUG=1
	CFLAGS += -DBLUETOOTH_SD=110

else ifeq ($(SD), s132)
	INC += -I$(SD_DIR)/$(SD)_$(MCU_VARIANT)_$(SOFTDEV_VERSION)/$(SD)_$(MCU_VARIANT)_$(SOFTDEV_VERSION)_API/include
	INC += -I$(SD_DIR)/$(SD)_$(MCU_VARIANT)_$(SOFTDEV_VERSION)/$(SD)_$(MCU_VARIANT)_$(SOFTDEV_VERSION)_API/include/$(MCU_VARIANT)
	CFLAGS += -DBLUETOOTH_SD_DEBUG=1
...
SOFTDEV_HEX_PATH = $(SD_DIR)/$(SD)_$(MCU_VARIANT)_$(SOFTDEV_VERSION)
